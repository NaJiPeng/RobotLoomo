...
package com.njp.robotloomo.camera;
...
import com.njp.robotloomo.MainActivity;
import com.njp.robotloomo.R;
import com.njp.robotloomo.manager.ConnectionManager;
...
//    }
    ...
    private void sendFrame() {
        ...
        ConnectionManager.INSTANCE.send(new BufferMessage(outputStream.toByteArray()), null);
        try {
            Thread.sleep(40);
        } catch (InterruptedException e) {
            e.printStackTrace();
